import { TriangleAlert as AlertTriangle, BookOpen, FileCheck, Phone, Shield, Users } from 'lucide-react-native';
...
const quickActions = [
  ...
  },
  {
    ...
    subtitle: 'Report professional misconduct',
    icon: AlertTriangle,
    color: '#dc2626',
  },
  {
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity style={styles.contactCard}>
          ...
          <View style={styles.contactInfo}>
            ...
            <Text style={styles.contactDetails}>012 338 9300</Text>
          </View>
        </TouchableOpacity>
      </View>
